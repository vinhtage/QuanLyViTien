                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Lịch sử chi tiêu</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    $sql_select = "SELECT * FROM ((t_chitien LEFT JOIN t_mucchi ON t_chitien.mamucchi=t_mucchi.mamucchi)LEFT JOIN t_vitien ON t_chitien.mavi=t_vitien.mavi) WHERE t_chitien.matk = '".$_SESSION["id"]."' ";
                                    ...
                                    echo "<thead>";
                                        echo "<tr>";
                                            ...
                                            echo "<th>Loại chi</th>";
                                            echo "<th>Ngày chi</th>";
                                            echo "<th>Số tiền chi</th>";
                                            echo "<th>Ghi chú</th>";
                                            echo "<th>Chi cho ai</th>";
                                            echo "<th>Sự kiện</th>";
                                        echo "</tr>";
                                    echo "</thead>"; 
                                    $i=0;
                                    ...
                                    while($r = mysqli_fetch_array($kq)){
                                        ...
                                        echo"<tbody>";
                                            echo "<tr>";
                                                echo "<td>".$r['tenvi']."</td>";
                                                echo "<td>".$r['tenmucchi']."</td>";
                                                echo "<td>".$r['ngaychi']."</td>";
                                                $ddtienwidget2 = number_format($r['sotienchi']); 
                                                echo "<td>".$ddtienwidget2."₫</td>";
                                                echo "<td>".$r['ghichu']."</td>";
                                                echo "<td>".$r['chichoai']."</td>";
                                                echo "<td>".$r['sukien']."</td>";
                                            echo "</tr>";
                                        echo "</tbody>";
                                            }               
